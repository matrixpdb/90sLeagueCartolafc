...
<head>
	...
	<title>Placar da Rodada </title>
	<link rel="stylesheet" type="text/css" href="css.css">
</head>
<body>
<div class="content" >
<?php
	$array = array("Noventas","sp.oliveirafc","B.N.W.","DFL09 FC","KSTD2","SAINT PAUL FC UNITED", "Yakubu fc","kammathe2017fc","Munhozsjc","RBC SOCCER CLUB","AA Gallo FC","Sonserina do amor FC",
        "GEA Corporation","Zero 8 centos","Esportake fc","Alveverde F.C","SoSeiGanharFC","SkiloMan F. C.","CRUDADERS FC","Bola no Alvo FC","Valdivias_FC","MVB City Evil","Munhoz.palmeiras","Piupiu.doglu.fc");
	...
	for($i = 0; $i < count($array); ++$i) {
	    ...
	    $url = 'https://api.cartolafc.globo.com/times?q='.$array[$i];
